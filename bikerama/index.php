      ...
      <header>
        <div class="row flex-nowrap justify-content-between align-items-center">
          <div class="col-4 pt-1">
            <img
              src="https://wiki.sj.ifsc.edu.br/images/2/2e/Sao_jose_horizontal_marca2015_PNG.png"
              alt="ifsc"
              width="100px"
            />
          </div>
          ...
          <div class="col-4 pt-1">
            <form class="d-flex" role="search">
              <div id="nome"></div>
              <a href="php/index.php" class="btn btn-outline-success"> Login</a>
            </form>
          </div>
        </div>
      </header>
        ...
        <div class="col-md-6">
          <div class="card mb-6">
            <div class="row g-0">
              ...
              <div class="col-md-4">
                <img
                  src="https://www.ifsc.edu.br/documents/23504/23634/Foto_C%C3%A2mpusChapec%C3%B3_2017.jpg/70658386-f096-6cff-e453-d76b289be4f8?t=1504298890892"
        ...
        <div class="col-md-6">
          <div class="card mb-6">
            <div class="row g-0">
              ...
              <div class="col-md-4">
                <img
                  src="https://static.amazonasbike.com.br/public/amazonasbike/imagens/produtos/bicicleta-amazonas-max-unissex-aro-20-1395-1836.png"
                  class="img-fluid rounded-start"
                  alt="..."
                />
              </div>
